/* Create a function to accept an array of marks in a class and return average */
...
{
	total+=marks[i];
	console.log("The current mark is "+marks[i]+" and the current total is "+total);
}
...
{
	let _total=0;
	let _numNumbers=numbers.length;
	let _avg=0;
